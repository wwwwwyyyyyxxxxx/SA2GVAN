...
class RandomAgent(habitat.Agent):
    ...
    def is_goal_reached(self, observations, dises):
    ...
    def act(self, observations, dises):
        action = np.array([np.where(self.is_goal_reached(observations, dises), HabitatSimActions.STOP, np.random.choice(
                [
