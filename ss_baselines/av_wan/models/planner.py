...
from ss_baselines.av_wan.models.mapper import Mapper, to_array, SA2Mapper
...
class SA2Planner:
    ...
    def __init__(self, task_config=None, use_acoustic_map=False, model_dir=None, masking=True, config=None):
        self.mapper = SA2Mapper(gm_config=task_config.TASK.GEOMETRIC_MAP, am_config=task_config.TASK.ACOUSTIC_MAP, action_map_config=task_config.TASK.ACTION_MAP, use_acoustic_map=use_acoustic_map, config=config)
        self.config = config
        self._action_map_res = task_config.TASK.ACTION_MAP.MAP_RESOLUTION
        self._action_map_size = task_config.TASK.ACTION_MAP.MAP_SIZE
        self._prev_depth = None
